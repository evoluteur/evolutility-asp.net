...
ALTER TABLE [EVOL_Restaurant] WITH NOCHECK ADD 
	CONSTRAINT [DF_EVOL_Restaurant_Name] DEFAULT ('[Untitled]') FOR [Name],	
	CONSTRAINT [DF_EVOL_Restaurant_CategoryID] DEFAULT (1) FOR [CategoryID],
	CONSTRAINT [DF_EVOL_Restaurant_Publish] DEFAULT (1) FOR [Publish],	
	CONSTRAINT [DF_EVOL_Restaurant_PriceID] DEFAULT (1) FOR [Price],
	CONSTRAINT [DF_EVOL_Restaurant_RatingID] DEFAULT (1) FOR [RatingID],
	CONSTRAINT [DF_EVOL_Restaurant_creationdate] DEFAULT (getdate()) FOR [creationdate],
	CONSTRAINT [DF_EVOL_Restaurant_CommentCount] DEFAULT (0) FOR [CommentCount]	
GO

ALTER TABLE [EVOL_Restaurant_Category] WITH NOCHECK ADD 
	CONSTRAINT [DF_EVOL_Restaurant_Category_Name] DEFAULT ('') FOR [Name]
GO

ALTER TABLE [EVOL_Restaurant_Rating] WITH NOCHECK ADD 
	CONSTRAINT [DF_EVOL_Restaurant_Rating_Name] DEFAULT ('') FOR [Name]
GO

ALTER TABLE [EVOL_Restaurant_Price] WITH NOCHECK ADD 
	CONSTRAINT [DF_EVOL_Restaurant_Price_Name] DEFAULT ('') FOR [Name]
GO
