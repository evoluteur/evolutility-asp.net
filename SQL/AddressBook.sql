...
/*** www.evolutility.com - (c) 2003-2008 Kakoo, Inc.  ***/
...
ALTER TABLE [EVOL_Contact] WITH NOCHECK ADD 
	CONSTRAINT [DF_EVOL_Contact_Private] DEFAULT (0) FOR [Publish],
	CONSTRAINT [DF_EVOL_Contact_UserID] DEFAULT (1) FOR [UserID],
	CONSTRAINT [DF_EVOL_Contact_CommentCount] DEFAULT (0) FOR [CommentCount],
	CONSTRAINT [DF_EVOL_Contact_creationdate] DEFAULT (getdate()) FOR [creationdate]
GO
...
INSERT INTO EVOL_Contact (Publish, UserID, Firstname, Lastname, Title, Company, CategoryID, Phone, Phoneh, Phonem, Fax, emailaddress, url, Addressline1, City, State, Zip, Notes)
  VALUES (1, 1, 'Olivier', 'Giulieri', 'CXO', 'Evolutility', 1, '', '', '', '', 'olivier@evolutility.com', 'http://www.evolutility.com', '', 'San Mateo', 'CA', '94401', 'Author of Evolutility');
INSERT INTO EVOL_Contact (Publish, UserID, Firstname, Lastname, Title, Company, CategoryID, Phone, Phoneh, Phonem, Fax, emailaddress, url, Addressline1, City, State, Zip, Notes)
