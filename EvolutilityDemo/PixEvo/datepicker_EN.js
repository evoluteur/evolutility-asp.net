...
function refreshDatePicker(fldName, year, month, day)
{
  ...
  // button
  var today = new Date();
  var todayString = "Today is " + dayArrMed[today.getDay()] + ", " + monthArrMed[ today.getMonth()] + " " + today.getDate();
  html += TR_todaybutton + TD_todaybutton;
  html += "<nobr><button class='Button' onClick='refreshDatePicker(\"" + fldName + "\");'>this month</button> ";
  html += "<button class='Button' onClick='updateDateField(\"" + fldName + "\");'>close</button></nobr>";
  html += xTD + xTR;
  html += "</table>"; 
